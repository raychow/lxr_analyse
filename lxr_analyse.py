...
if __name__ == '__main__':
    ...
    for stock_code, stock_code_desc in lxr_fetch.stock_codes.items():
        ...
        with open(output_file_template.format(stock_code, stock_code_name), 'w') as f:
            f.write('date,market_value,pe,pb,pe_temp,pb_temp,(pe_temp+pb_temp)/2\n')
            for metric, pe_temp, pb_temp in zip(metrics, pes_temp, pbs_temp):
                f.write('{},{},{},{},{},{},{}\n'.format(
                    format_json_date(metric['date']),
        ...
        aggregated.append([
            ...
            get_market_value(metric), get_pe(last_metric), get_pb(last_metric), get_ps(last_metric),
    ...
    with open(aggregate_file_template, 'w') as f:
        f.write('date,stock_code,stock_code_name,market_value,pe,pb,ps,pe_temp,pb_temp,(pe_temp+pb_temp)/2\n')
        for a in aggregated:
